...
ActiveRecord::Schema[7.0].define(version: 2023_06_08_120034) do
  ...
  create_table "service_providers", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "service_provider_category_id"
    t.string "bio"
    t.string "phone_number"
    t.jsonb "address"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["service_provider_category_id"], name: "index_service_providers_on_service_provider_category_id"
